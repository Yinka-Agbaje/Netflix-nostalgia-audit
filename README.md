# 🎬 Netflix-nostalgia-audit: 1990s Cinematic Trends Analysis
...
## 📂 Project Structure
- `/data`: `netflix_data.csv` (Global Netflix catalog).
- `/notebooks`: Exploratory analysis and visualization scripts.
- `requirements.txt`: Environment dependencies.

## 📈 Industry Insights & Executive Summary

### 1. The "Golden Runtime"
